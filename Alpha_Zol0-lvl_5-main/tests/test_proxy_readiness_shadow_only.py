...
def test_shadow_ready_uses_only_existing_proxy_signals():
    entry = {
        ...
        "entry_edge_over_fee": {"mean_edge_over_fee": 0.1, "mean_fee_total": 0.01, "mean_spread_slippage_proxy": 0.02},
    }
...
def test_build_report_has_separation_guarantees():
    report = shadow._build_report()
...
def test_report_contains_shadow_namespace_and_metrics():
    report = shadow._build_report()
...
def test_md_render_mentions_shadow_only():
    report = shadow._build_report()
