...
## Strategy Ranking
- `MEANREVERSION` events=`672` best_net=`0.003372035335` best_mfe=`0.003622191262`
...
- `MEANREVERSION:BTCUSDTM:sell:h10` net=`0.00225208974` gross=`0.002502245256` cost=`0.000250155516`
- `MEANREVERSION:XRPUSDTM:sell:h10` net=`0.00216539955` gross=`0.002416247356` cost=`0.000250847806`
